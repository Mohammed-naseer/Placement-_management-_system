...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/css/**", "/js/**", "/images/**", "/icons/**", "/fonts/**", "/uploads/**").permitAll()
                .requestMatchers("/", "/index", "/login", "/register", "/forgot-password").permitAll()
                .requestMatchers("/student/**", "/recruiter/**", "/admin/**", "/ai/**", "/errors/**").permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Allow common frontend ports (Vite 5173, standard react 3000)
